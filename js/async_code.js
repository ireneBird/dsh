...
function CheckForPlugIn_Async() {
    function VersionCompare_Async(StringVersion, ObjectVersion)
    {
        ...
        cadesplugin.async_spawn(function *() {
            ...
            document.getElementById('PlugInVersionTxt').innerHTML = "(версия " + (yield CurrentPluginVersion.toString()) + ")";
            ...
            document.getElementById('CSPVersionTxt').innerHTML = "(версия " + ret + ")";
